...
// Get all bank accounts to display in the view
$bank_data = getAllBankAccounts();

// Handle messages from POST/GET operations
$success_message = isset($_GET['success']) ? $_GET['success'] : null;
$error_message = isset($_GET['error']) ? $_GET['error'] : null;

// Include the JavaScript required for the edit modal functionality
