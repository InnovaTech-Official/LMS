...
try {
    ...
    // Use pgsql for PostgreSQL connection
    $pdo = new PDO("pgsql:host=$servername;dbname=$dbname", $username, $password, $options);
    ...
    // Include local config (make sure local_config.php uses PostgreSQL too)
    include_once __DIR__ . '/local_db.php';
