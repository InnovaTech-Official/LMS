<?php
include_once "../../../controllers/setup/branchsetup/index.php";
...
<body>
    <div class="container">
        ...
        <form method="post" id="branchSetupForm">
            <div class="card">

                <div class="successMessage" id="successMessage" style="padding: 8px; margin: 8px 0px; background-color: white; color: #1E3A8A; border-radius: 30px; display: none;"></div>
    ...
    <script src="../../../assets/js/setup/branchSetup.js"></script>
</body>
