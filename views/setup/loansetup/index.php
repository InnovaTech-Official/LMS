...
<head>
    ...
    <link rel="stylesheet" href="../../../assets/css/loansetup.css">
</head>
<body>
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="form-group">
                ...
                <div class="checkbox-list"> <div class="checkbox-group"> <input type="checkbox" id="repaymentDaily" name="repaymentFrequency" value="daily"> <label for="repaymentDaily">Daily</label>
                    </div>
        ...
        <div class="card">
            ...
            <div class="repayment-order-controls">
                <div class="form-group repayment-order-list">
                    ...
                    <select id="repaymentOrderList" multiple size="4">
    ...
    <script src="../../../assets/js/setup/loansetup.js"></script>
</body>
</html>